...
public class URIBuilderTest {
    ...
    public void testParseString(){
        URI uri1 = URIBuilder.fromString("/subject/XXXXXXXXXXX/medication-scheme/47190");
        log.info(uri1);
        log.info(URIWriter.toString(uri1));
        URI uri2 = (URIBuilder.fromString("/subject/XXXXXXXXXXX/medication-scheme/47190/1"));
        log.info(uri2);
        log.info(URIWriter.toString(uri2));
        log.info("URI for update: " + URIWriter.toString(URIConverter.convertToUpdate(uri2)));
        URI uri3 = (URIBuilder.fromString("/subject/XXXXXXXXXXX/medication-scheme/47190/new/1"));
        log.info(uri3);
        log.info(URIWriter.toString(uri3));
        URI uri4 = (URIBuilder.fromString("/subject/XXXXXXXXXXX/medication-scheme/new"));
        log.info(uri4);
        log.info(URIWriter.toString(uri4));
        URI uri5 = (URIBuilder.fromString("/subject/XXXXXXXXXXX/vaccination/B1BFB33C7CD24729A866A869F44CA9F8/1"));
        log.info(uri5);
